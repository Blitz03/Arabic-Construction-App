...
export function addBusinessJsonLd() {
  return JSON.stringify({
    ...
    "@type": "LocalBusiness",
    name: "شركة النهضة للمقاولات العامة والمشاريع البنائية في الكويت",
    description:
    ...
    url: "https://alnahdakw.com/",
    image: [
      "/assets/services-01.jpg",
      "/assets/services-02.jpg",
      "/assets/services-03.jpg",
      "/assets/services-04.jpg",
